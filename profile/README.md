...
Sora は [Raft](https://raft.github.io/raft.pdf) や [Plumtree (Epidemic Broadcast Trees)](https://www.dpss.inesc-id.pt/~ler/reports/srds07.pdf) を利用した分散リアルタイムコミュニケーションサーバーです。
